...
-- Target: ar_rate_hist (Silver Layer)
-- ====================================================================
...
SELECT 
    ...
    TRY_CAST(a.INTEREST_RATE AS DECIMAL(10,4))             AS EFF_RATE_PCT,
    TRY_CAST(a.INTEREST_SPREAD AS DECIMAL(10,4))           AS SPRD_RATE_PCT,
    TRY_CAST(a.PE_RATE AS DECIMAL(10,4))                   AS PNY_RATE,
    TRY_CAST(a.PS_RATE AS DECIMAL(10,4))                   AS ODUE_INT_RATE,
    TRY_CAST(d.BIEN_DO_THAY_DOI_LS_THEO_HDTD AS DECIMAL(10,4)) AS MRGN_RATE,
...
LEFT JOIN bz_flexbo_pgb_los_contract_fields_tdate d
