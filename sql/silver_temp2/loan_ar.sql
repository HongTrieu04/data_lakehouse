...
his_branch AS (
    SELECT 
        ...
        FCC_LIMIT                                            AS FCC_LMT_CODE,
        TO_DATE(FIN_MAT_DATE, 'yyyyMMdd')                    AS MAT_DT,
        INPUTTER                                             AS MAKER_OFCR_CODE,
        sha2(concat('T24_LIMIT', LIMIT_REFERENCE), 256)      AS LMT_ID,
        LIMIT_REFERENCE                                      AS LMT_CODE,
        LOC_TERM                                             AS TERM_CODE,
        LOS_FAC_CODE                                         AS LOS_CTR_NBR,
